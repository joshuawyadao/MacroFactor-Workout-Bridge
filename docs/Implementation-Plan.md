...
[ ] Apply case-insensitive distinct-label validation to block reports too (Codex 4040359713); retain valid block metrics and report ambiguous blocks instead of calculating them.
