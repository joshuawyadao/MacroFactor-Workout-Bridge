...
[ ] Exclude duplicate coach-week labels from calendar mapping (Codex 4040229297); test ambiguous labels without changing valid mappings.
[ ] Retry failed current-link reconciliation for known archives (Codex 4040229304); test obstruction removal, repeated warnings and no empty ingest manifests.
